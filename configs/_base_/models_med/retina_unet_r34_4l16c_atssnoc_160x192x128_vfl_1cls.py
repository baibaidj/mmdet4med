_base_ = [ '../datasets/ribfrac_instance_semantic_inhouse_160x192x128.py',]
...
model = dict(
    ...
    # mmdet/datasets/transform4med/instances.py 中注册的类
    ...
    train_cfg=dict(
        ...
        debug=False),
    test_cfg=dict(
        nms_pre=200, min_bbox_size=2,
        score_thr=0.25, max_per_img=32, 
        ...
        mode='slide', roi_size = {{ _base_.patch_size }}, 
        sw_batch_size = 8, overlap=0.4,
        blend_mode = 'gaussian',  sigma_scale = 0.125, # 'gaussian or constant
