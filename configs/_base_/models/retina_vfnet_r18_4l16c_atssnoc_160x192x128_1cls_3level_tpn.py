...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_cls=dict(
            ...
            iou_weighted=True,
            loss_weight=4.0),
        loss_bbox=dict(type='GIoULoss3D', loss_weight=1.0/2),
        loss_bbox_refine=dict(type='GIoULoss3D', loss_weight=1.0/2)
        ), 
    seg_head = dict(
    ...
    test_cfg=dict(
        ...
        blend_mode = 'gaussian' , overlap=0.3, sigma_scale = 0.125, # 'gaussian or constant
