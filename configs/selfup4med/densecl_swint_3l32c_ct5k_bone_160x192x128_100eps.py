_base_ = [
    '../_base_/models_med/densecl_swint_3l32c_160x192x128.py',
...
model = dict(queue_len= 3 * 2**14, 
             init_cfg = None, #init_cfg=dict(type='Pretrained', checkpoint=pretrained)
             )

find_unused_parameters=True
load_from = None # 'work_dirs/densecl_swint_4l16c_ct5k_bone_160x192x128_100eps/latest.pth'
...
# CUDA_VISIBLE_DEVICES=0 python tools/train.py configs/ribfrac/densecl_swint_3l32c_ct5k_bone_160x192x128_100eps.py --no-validate
# CUDA_VISIBLE_DEVICES=0,2,4 PORT=29227 bash ./tools/dist_train.sh configs/ribfrac/densecl_swint_3l32c_ct5k_bone_160x192x128_100eps.py 3 --gpus 3 --no-validate
