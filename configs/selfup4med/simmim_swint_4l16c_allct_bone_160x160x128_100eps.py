...
data = dict(samples_per_gpu = 6, workers_per_gpu= 12, 
...
load_from = 'work_dirs/simmim_swint_4l16c_allct_bone_160x160x128_100eps/latest.pth'
...
# CUDA_VISIBLE_DEVICES=4 python tools/train.py configs/ribfrac/simmim_swint_4l16c_allct_bone_160x160x128_100eps.py --no-validate
# CUDA_VISIBLE_DEVICES=1,3,5 PORT=29010 bash ./tools/dist_train.sh configs/ribfrac/simmim_swint_4l16c_allct_bone_160x160x128_100eps.py 3 --gpus 3 --no-validate
