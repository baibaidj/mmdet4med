...
load_from = 'work_dirs/simmim_swint_4l16c_allct_bone_160x160x128_100eps_interp/latest.pth'
...
# CUDA_VISIBLE_DEVICES=4 python tools/train.py configs/ribfrac/simmim_swint_4l16c_allct_bone_160x16
# 0x128_100eps_interp.py --no-validate
