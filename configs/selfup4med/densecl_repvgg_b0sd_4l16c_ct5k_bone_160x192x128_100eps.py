_base_ = [
    '../_base_/models_med/densecl_repvgg_b0sd_4l16c_160x192x128.py',
...
load_from = None # 'work_dirs/densecl_r18_4l16c_ct5k_bone_160x192x128_100eps/latest.pth'
...
# CUDA_VISIBLE_DEVICES=1 python tools/train.py configs/ribfrac/densecl_repvgg_b0sd_4l16c_ct5k_bone_160x192x128_100eps.py --no-validate
# CUDA_VISIBLE_DEVICES=0,2 PORT=29010 bash ./tools/dist_train.sh configs/ribfrac/densecl_repvgg_b0sd_4l16c_ct5k_bone_160x192x128_100eps.py 2 --gpus 2 --no-validate
