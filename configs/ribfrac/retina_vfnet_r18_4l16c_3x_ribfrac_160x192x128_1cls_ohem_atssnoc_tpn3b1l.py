_base_ = [
    '../_base_/models_med/retina_vfnet_r18_4l16c_atssnoc_160x192x128_1cls_3level_tpn.py',
...
model = dict(
            neck = dict(num_bottleneck = 3, num_tpn = 1),
            bbox_head = dict(
...
load_from = 'work_dirs/retina_vfnet_r18_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_tpn3b1l/latest.pth'
...
# CUDA_VISIBLE_DEVICES=0 python tools/train.py configs/ribfrac/retina_vfnet_r18_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_tpn3b1l.py 
# CUDA_VISIBLE_DEVICES=0,2,4,5 PORT=29034 bash ./tools/dist_train.sh configs/ribfrac/retina_vfnet_r18_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_tpn3b1l.py 4 --gpus 4 #--no-validate
