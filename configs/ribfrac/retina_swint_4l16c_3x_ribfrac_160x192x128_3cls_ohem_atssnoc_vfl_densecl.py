_base_ = [
    '../_base_/models_med/retina_swint_4l16c_atssnoc_160x192x128_vfl_3cls.py',
...
# densecl_cp = 'work_dirs/densecl_swint_4l16c_ct5k_bone_160x192x128_100eps/latest.pth'
model = dict(
...
load_from = 'work_dirs/retina_swint_4l16c_3x_ribfrac_160x192x128_3cls_ohem_atssnoc_vfl_densecl/latest.pth'
...
# CUDA_VISIBLE_DEVICES=0 python tools/train.py configs/ribfrac/retina_swint_4l16c_3x_ribfrac_160x192x128_3cls_ohem_atssnoc_vfl_densecl.py 
# CUDA_VISIBLE_DEVICES=1,3,5 PORT=29340 bash ./tools/dist_train.sh configs/ribfrac/retina_swint_4l16c_3x_ribfrac_160x192x128_3cls_ohem_atssnoc_vfl_densecl.py 3 --gpus 3 #--no-validate

# 32 epochs: mAP 0.2337
# 32 epochs: mAP 0.3566
