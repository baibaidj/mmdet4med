_base_ = [
    '../_base_/models_med/retina_vfnet_r34_4l16c_atssnoc_160x192x128_1cls_fapn.py',
...
# CUDA_VISIBLE_DEVICES=0 python tools/train.py configs/ribfrac/retina_vfnet_r34_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_fapn.py 
# CUDA_VISIBLE_DEVICES=0,2,4 PORT=29234 bash ./tools/dist_train.sh configs/ribfrac/retina_vfnet_r34_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_fapn.py 3 --gpus 3 --no-validate
