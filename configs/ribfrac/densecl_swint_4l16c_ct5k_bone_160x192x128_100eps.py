...
model = dict(backbone=dict(depths=[2, 2, 4, 2]), 
             queue_len= 3 * 2**14, 
...
resume_from = 'work_dirs/densecl_swint_4l16c_ct5k_bone_160x192x128_100eps/latest.pth'
...
# CUDA_VISIBLE_DEVICES=0,2,4 PORT=29227 bash ./tools/dist_train.sh configs/ribfrac/densecl_swint_4l16c_ct5k_bone_160x192x128_100eps.py 3 --gpus 3 --no-validate
