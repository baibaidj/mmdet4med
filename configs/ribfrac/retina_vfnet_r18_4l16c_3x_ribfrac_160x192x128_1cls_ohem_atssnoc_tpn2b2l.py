_base_ = [
    '../_base_/models/retina_vfnet_r18_4l16c_atssnoc_160x192x128_1cls_3level_tpn.py',
...
load_from = 'work_dirs/retina_unet_r18_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_vfl_a2g/best_recall@8@0.1_epoch_18.pth'
...
# CUDA_VISIBLE_DEVICES=0 python tools/train.py configs/ribfrac/retina_vfnet_r18_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_tpn2b2l.py 
# CUDA_VISIBLE_DEVICES=0,2,4 PORT=29034 bash ./tools/dist_train.sh configs/ribfrac/retina_vfnet_r18_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_tpn2b2l.py 3 --gpus 3 #--no-validate
