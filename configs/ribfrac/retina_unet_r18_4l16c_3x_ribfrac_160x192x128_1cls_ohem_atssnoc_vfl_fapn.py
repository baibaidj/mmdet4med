...
load_from = 'work_dirs/retina_unet_r18_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_vfl_fapn/epoch_1.pth'
...
# CUDA_VISIBLE_DEVICES=1,3,5 PORT=29266 bash ./tools/dist_train.sh configs/ribfrac/retina_unet_r18_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_vfl_fapn.py 3 --gpus 3 #--no-validate
