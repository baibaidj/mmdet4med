_base_ = [
    '../_base_/models_med/retina_unet_repvgg_b0sd_atssnoc_160x192x128_vfl_syncbn.py',
...
load_from = 'work_dirs/retina_unet_repvgg_b0sd_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_vfl_densecl/latest.pth'
resume_from = None #'work_dirs/retina_unet_repvgg_b0sd_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_vfl_densecl/latest.pth' 
...
lr_config = dict(_delete_=True, 
                # policy='poly', power=0.99, min_lr=5e-5, 
...
evaluation=dict(interval=4, start=0, metric='mAP', 
                ...
                # save_best='mAP@8@0.1', 
                iou_thr=[0.2, 0.3])
# CUDA_VISIBLE_DEVICES=1 python tools/train.py configs/ribfrac/retina_unet_repvgg_b0sd_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_vfl_densecl.py 
# CUDA_VISIBLE_DEVICES=1,3,5 PORT=29346 bash ./tools/dist_train.sh configs/ribfrac/retina_unet_repvgg_b0sd_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_vfl_densecl.py 3 --gpus 3 #--no-validate
