_base_ = [
    '../_base_/models_med/retina_unet_cnext_s32c32k5_atssdy_160x192x128_vfl_1cls.py',
...
# CUDA_VISIBLE_DEVICES=5 python tools/train.py configs/ribfrac/retina_unet_cnext_s32c32k5_rf1231_160x192x128_1cls_ohem_atssdy_ce.py 
# CUDA_VISIBLE_DEVICES=1,3,5 PORT=29033 bash ./tools/dist_train.sh configs/ribfrac/retina_unet_cnext_s32c32k5_rf1231_160x192x128_1cls_ohem_atssdy_ce.py 3 --gpus 3 #--no-validate
