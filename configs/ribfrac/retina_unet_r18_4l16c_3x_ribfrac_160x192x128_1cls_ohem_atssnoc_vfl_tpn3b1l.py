...
model = dict(neck = dict(num_bottleneck = 2, num_tpn = 1),
            bbox_head = dict(
...
load_from = 'work_dirs/retina_unet_r18_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_vfl_tpn3b1l/latest.pth'
resume_from = None # 'work_dirs/retina_unet_r18_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_vfl_tpn3b1l/latest.pth' 
...
lr_config = dict(_delete_=True, 
                ...
                # policy='CosineAnnealing', min_lr=1e-6
                 )
...
# CUDA_VISIBLE_DEVICES=0 python tools/train.py configs/ribfrac/retina_unet_r18_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_vfl_tpn3b1l.py 
# CUDA_VISIBLE_DEVICES=0,2,4 PORT=29034 bash ./tools/dist_train.sh configs/ribfrac/retina_unet_r18_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_vfl_tpn3b1l.py 3 --gpus 3 #--no-validate
