_base_ = [
    '../_base_/models_med/retina_unet_r34_4l8c_atss_160x192x128_3anchor.py',
...
load_from = None #'work_dirs/retina_unet_r34_4l8c_3x_ribfrac_160x192x128_1cls_ohem_atss_3anchor/latest.pth'
...
# fp16 = dict(loss_scale = dict(init_scale=65536.0, growth_factor=2.0, 
...
evaluation=dict(interval=1, iou_thr=[0.1], proposal_nums=(1, 2, 4, 8, 50))
# CUDA_VISIBLE_DEVICES=5 python tools/train.py configs/ribfrac/retina_unet_r34_4l8c_3x_ribfrac_160x192x128_1cls_ohem_atss_3anchor.py 
# CUDA_VISIBLE_DEVICES=0,2,4,5 PORT=29034 bash ./tools/dist_train.sh configs/ribfrac/retina_unet_r34_4l8c_3x_ribfrac_160x192x128_1cls_ohem_atss_3anchor.py 4 --gpus 4 #--no-validate
