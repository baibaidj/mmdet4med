_base_ = [
    '../_base_/models_med/retina_vfnet_r34_4l16c_atssnoc_160x192x128_1cls_3level.py',
...
load_from = 'work_dirs/retina_vfnet_r34_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_3level/best_mAP_epoch_2.pth'
resume_from =  None # 'work_dirs/retina_vfnet_r34_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_3level/latest.pth' 
...
# learning policy
lr_config = dict(_delete_=True, policy='poly', power=0.99, min_lr=6e-5, by_epoch=False,
...
evaluation=dict(interval=4, start=2, metric='mAP', 
                save_best = 'mAP', rule = 'greater', 
                iou_thr=[0.1], proposal_nums=(1, 2, 4, 8, 50))


# CUDA_VISIBLE_DEVICES=5 python tools/train.py configs/ribfrac/retina_vfnet_r34_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_3level.py 
# CUDA_VISIBLE_DEVICES=1,3,5 PORT=29239 bash ./tools/dist_train.sh configs/ribfrac/retina_vfnet_r34_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_3level.py 3 --gpus 3 #--no-validate
