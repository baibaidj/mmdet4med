...
model = dict(
        ...
        bbox_head = dict(verbose = False, use_vfl = False, 
                        anchor_generator = dict(ratios=[1/2, 1.0, 2.0], verbose = False), 
...
load_from = 'work_dirs/retina_unet_r34_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_1130/best_mAP_epoch_32.pth'
resume_from =  None # 'work_dirs/retina_unet_r34_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_vfl_densecl/latest.pth' 
...
# CUDA_VISIBLE_DEVICES=0 python tools/train.py configs/ribfrac/retina_unet_r34_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_anc14_1130.py 
# CUDA_VISIBLE_DEVICES=0,2,4 PORT=29342 bash ./tools/dist_train.sh configs/ribfrac/retina_unet_r34_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_anc14_1130.py 3 --gpus 3 #--no-validate
