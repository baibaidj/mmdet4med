...
# CUDA_VISIBLE_DEVICES=5 python tools/train.py configs/ribfrac/retina_vfnet_r34_4l16c_3x_ribfrac_160x192x128_3cls_ohem_atssnoc_3level.py 
# CUDA_VISIBLE_DEVICES=0,2,4,5 PORT=29239 bash ./tools/dist_train.sh configs/ribfrac/retina_vfnet_r34_4l16c_3x_ribfrac_160x192x128_3cls_ohem_atssnoc_3level.py 4 --gpus 4 #--no-validate
