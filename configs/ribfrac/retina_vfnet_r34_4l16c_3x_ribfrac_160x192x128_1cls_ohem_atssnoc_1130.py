_base_ = [
    '../_base_/models_med/retina_vfnet_r34_4l16c_atssnoc_160x192x128_1cls.py',
...
model = dict(
        ...
        bbox_head = dict(verbose = False, use_vfl = True, 
                        ...
                        loss_bbox=dict(loss_weight=0.75),
                        loss_bbox_refine=dict(loss_weight=0.75)
                            ), 
        train_cfg=dict(
...
# CUDA_VISIBLE_DEVICES=5 python tools/train.py configs/ribfrac/retina_vfnet_r34_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_1130.py 
# CUDA_VISIBLE_DEVICES=1,3,5 PORT=29341 bash ./tools/dist_train.sh configs/ribfrac/retina_vfnet_r34_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_1130.py 3 --gpus 3 #--no-validate
