...
model = dict(
        bbox_head = dict(verbose = False, use_vfl = True, 
                        loss_cls_vfl=dict(alpha=0.75, loss_weight=10.0),
...
load_from =  'work_dirs/retina_unet_r34_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_vfl_1222/latest.pth'
...
optimizer = dict(
                ...
                _delete_ = True, type='AdamW', lr=1e-4, weight_decay=1e-3
        ) 
...
# CUDA_VISIBLE_DEVICES=5 python tools/train.py configs/ribfrac/retina_unet_r34_4l16c_3x_ribfrac_160x192x128_3cls_ohem_atssnoc_vfl_1222.py 
# CUDA_VISIBLE_DEVICES=1,3,5 PORT=29024 bash ./tools/dist_train.sh configs/ribfrac/retina_unet_r34_4l16c_3x_ribfrac_160x192x128_3cls_ohem_atssnoc_vfl_1222.py 3 --gpus 3 #--no-validate
