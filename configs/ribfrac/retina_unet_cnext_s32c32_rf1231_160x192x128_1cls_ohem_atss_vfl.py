...
model = dict(
        ...
        #                 ), 
        neck = dict(upsample_cfg=dict(use_norm = True), verbose = False),
        ...
        test_cfg = dict(nms_pre=300, score_thr=0.2, max_per_img=24, sw_batch_size = 6, overlap=0.4),                
    )

find_unused_parameters=True
load_from = 'work_dirs/retina_unet_cnext_s32c32_rf1231_160x192x128_1cls_ohem_atss_vfl/latest.pth'
resume_from = None # 'work_dirs/retina_unet_cnext_s32c32_rf1231_160x192x128_1cls_ohem_atss_vfl/latest.pth' 

# optimizer
optimizer = dict(
                # type='SGD', lr=1e-3, momentum=0.9, weight_decay=0.0001, 
                _delete_ = True, type='AdamW', lr=1e-4, weight_decay=1e-2
        ) 
...
# CUDA_VISIBLE_DEVICES=0 python tools/train.py configs/ribfrac/retina_unet_cnext_s32c32_rf1231_160x192x128_1cls_ohem_atss_vfl.py 
# CUDA_VISIBLE_DEVICES=1,3,5 PORT=29033 bash ./tools/dist_train.sh configs/ribfrac/retina_unet_cnext_s32c32_rf1231_160x192x128_1cls_ohem_atss_vfl.py 3 --gpus 3 #--no-validate
