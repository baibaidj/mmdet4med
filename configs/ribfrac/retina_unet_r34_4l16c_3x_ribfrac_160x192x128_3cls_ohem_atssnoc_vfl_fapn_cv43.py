...
data = dict(samples_per_gpu = 2, workers_per_gpu= 6, 
            train=dict(sample_rate = 1.0, json_filename = 'dataset_1105_3-4.json', img_dir=img_dir, key2suffix = key2suffix), 
            val=dict(sample_rate = 1.0, json_filename = 'dataset_1105_3-4.json', img_dir=img_dir, key2suffix = key2suffix), 
            test= dict(sample_rate = 0.1, json_filename = 'dataset_1105_3-4.json',img_dir=img_dir, key2suffix = key2suffix))
...
# CUDA_VISIBLE_DEVICES=2 python tools/train.py configs/ribfrac/retina_unet_r34_4l16c_3x_ribfrac_160x192x128_3cls_ohem_atssnoc_vfl_fapn_cv43.py 
# CUDA_VISIBLE_DEVICES=0,2,4 PORT=29343 bash ./tools/dist_train.sh configs/ribfrac/retina_unet_r34_4l16c_3x_ribfrac_160x192x128_3cls_ohem_atssnoc_vfl_fapn_cv43.py 3 --gpus 3 #--no-validate
