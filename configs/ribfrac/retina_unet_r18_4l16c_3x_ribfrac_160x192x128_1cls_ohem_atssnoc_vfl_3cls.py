_base_ = [
    '../_base_/models/retina_unet_r18_4l16c_atssnoc_160x192x128_vfl_3cls.py',
...
resume_from = None #'work_dirs/retina_unet_r18_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_vfl_3cls/latest.pth' 
...
evaluation=dict(interval=4, start=16, metric='mAP', 
                save_best = 'mAP', rule = 'greater', 
                # save_best='mAP@8@0.1', 
                iou_thr=[0.1], proposal_nums=(1, 2, 4, 8, 50))


# CUDA_VISIBLE_DEVICES=5 python tools/train.py configs/ribfrac/retina_unet_r18_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_vfl_3cls.py 
# CUDA_VISIBLE_DEVICES=1,3,5 PORT=29034 bash ./tools/dist_train.sh configs/ribfrac/retina_unet_r18_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_vfl_3cls.py 3 --gpus 3 #--no-validate
