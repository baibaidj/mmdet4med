_base_ = [
    '../_base_/models_med/retina_vfnet_r34_4l16c_atssnoc_160x192x128_3cls.py',
...
load_from = 'work_dirs/retina_vfnet_r34_4l16c_3x_ribfrac_160x192x128_3cls_ohem_atssnoc/best_mAP_epoch_48.pth'
...
# learning policy
lr_config = dict(_delete_=True, policy='poly', power=0.99, min_lr=8e-5, by_epoch=False,
...
# CUDA_VISIBLE_DEVICES=5 python tools/train.py configs/ribfrac/retina_vfnet_r34_4l16c_3x_ribfrac_160x192x128_3cls_ohem_atssnoc.py 
# CUDA_VISIBLE_DEVICES=4,5 PORT=29239 bash ./tools/dist_train.sh configs/ribfrac/retina_vfnet_r34_4l16c_3x_ribfrac_160x192x128_3cls_ohem_atssnoc.py 2 --gpus 2 #--no-validate
