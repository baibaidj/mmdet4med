...
model = dict(
        bbox_head = dict(stacked_convs=6, verbose = False, 
                        initial_loss_cls=dict(loss_weight=2.0, alpha=0.8), 
...
load_from =  None #'work_dirs/retina_unet_r34_4l16c_3x_ribfrac_160x192x128_3cls_ohem_atssnoc_tood_1130/latest.pth'
resume_from =  'work_dirs/retina_unet_r34_4l16c_3x_ribfrac_160x192x128_3cls_ohem_atssnoc_tood_1130/latest.pth' 
