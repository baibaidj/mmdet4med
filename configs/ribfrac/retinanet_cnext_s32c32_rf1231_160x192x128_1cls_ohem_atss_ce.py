_base_ = [
    '../_base_/models_med/retinanet_cnext_s32c32_atss_160x192x128_vfl_1cls.py',
...
optimizer = dict(
                ...
                _delete_ = True, type='AdamW', lr=2e-4, weight_decay=0.05
        ) 
...
# CUDA_VISIBLE_DEVICES=0 python tools/train.py configs/ribfrac/retinanet_cnext_s32c32_rf1231_160x192x128_1cls_ohem_atss_ce.py 
# CUDA_VISIBLE_DEVICES=1,3,5 PORT=29033 bash ./tools/dist_train.sh configs/ribfrac/retinanet_cnext_s32c32_rf1231_160x192x128_1cls_ohem_atss_ce.py 3 --gpus 3 #--no-validate
