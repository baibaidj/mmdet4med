...
model = dict(
        ...
        test_cfg=dict(min_bbox_size=1, score_thr=0.15, overlap=0.4, max_per_img=64)
        )

find_unused_parameters=True
load_from =  'work_dirs/retina_unet_r34_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_vfl_1130/latest.pth'
resume_from =  None #'work_dirs/retina_unet_r34_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_vfl_1130/latest.pth' 
