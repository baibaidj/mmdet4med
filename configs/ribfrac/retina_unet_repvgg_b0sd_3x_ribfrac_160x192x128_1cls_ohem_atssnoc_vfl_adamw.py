...
load_from = 'work_dirs/retina_unet_repvgg_b0sd_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_vfl_adamw/best_recall@8@0.1_epoch_24.pth'
...
lr_config = dict(_delete_=True, policy='CosineAnnealing',min_lr=5e-5, by_epoch=False,
...
# CUDA_VISIBLE_DEVICES=1 python tools/train.py configs/ribfrac/retina_unet_repvgg_b0sd_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_vfl_adamw.py 
# CUDA_VISIBLE_DEVICES=1,3,5 PORT=29346 bash ./tools/dist_train.sh configs/ribfrac/retina_unet_repvgg_b0sd_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_vfl_adamw.py 3 --gpus 3 #--no-validate
