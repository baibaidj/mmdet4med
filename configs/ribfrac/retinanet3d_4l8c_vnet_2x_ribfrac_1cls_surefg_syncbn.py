_base_ = [
    '../_base_/models/retinanet_r18_4l8c_vnet_3d_surefg_syncbn.py',
...
load_from = 'work_dirs/retinanet3d_4l8c_vnet_2x_ribfrac_1cls_surefg_syncbn/latest.pth'
...
# CUDA_VISIBLE_DEVICES=1 python tools/train.py configs/ribfrac/retinanet3d_4l8c_vnet_2x_ribfrac_1cls_surefg_syncbn.py 
# CUDA_VISIBLE_DEVICES=1,3 PORT=29012 bash ./tools/dist_train.sh configs/ribfrac/retinanet3d_4l8c_vnet_2x_ribfrac_1cls_surefg_syncbn.py 2 --gpus 2 #--no-validate
# CUDA_VISIBLE_DEVICES=1 python tools/test_med.py configs/ribfrac/retinanet3d_4l8c_vnet_3x_ribfrac_1cls_syncbn.py 
