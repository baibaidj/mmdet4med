_base_ = [
    '../_base_/models/retina_tpn_r18_4l16c_atssnoc_160x192x128_vfl_1anchor.py',
...
load_from = None # 'work_dirs/retina_unet_r18_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_vfl/epoch_30.pth'
...
# CUDA_VISIBLE_DEVICES=0 python tools/train.py configs/ribfrac/retina_tpn_r18_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_vfl.py 
# CUDA_VISIBLE_DEVICES=0,2,4 PORT=29034 bash ./tools/dist_train.sh configs/ribfrac/retina_tpn_r18_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_vfl.py 3 --gpus 3 #--no-validate
