_base_ = [
    '../_base_/models_med/retina_unet_r18_4l16c_atssnoc_160x192x128_vfl.py',
...
load_from = 'work_dirs/retina_unet_r18_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_vfl_ft/epoch_30_best.pth'
resume_from = None # 'work_dirs/retina_unet_r18_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_vfl_ft/latest.pth' 
...
# CUDA_VISIBLE_DEVICES=0 python tools/train.py configs/ribfrac/retina_unet_r18_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_vfl_14anchor.py 
