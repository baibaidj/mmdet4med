_base_ = [
    '../_base_/models_med/retina_unet_r34_4l8c_atssnoc_160x192x128.py',
...
optimizer = dict(#type='SGD', lr=0.01, momentum=0.9, weight_decay=0.0001, 
                _delete_ = True, type='AdamW', lr=0.0008, weight_decay=0.0005
        ) 
optimizer_config = dict(_delete_ = True, grad_clip = dict(max_norm = 64, norm_type = 2)) # 31G
fp16 = dict(loss_scale = dict(init_scale=2**9, growth_factor=2.0, 
...
# CUDA_VISIBLE_DEVICES=5 python tools/train.py configs/ribfrac/retina_unet_r34_4l8c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc.py 
# CUDA_VISIBLE_DEVICES=0,2,4,5 PORT=29034 bash ./tools/dist_train.sh configs/ribfrac/retina_unet_r34_4l8c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc.py 4 --gpus 4 #--no-validate
