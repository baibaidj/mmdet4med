_base_ = [
    '../_base_/models_med/retina_unet_r34_4l16c_atssdy_160x192x128_vfl_1cls.py',
...
optimizer_config = dict(_delete_ = True, grad_clip = dict(max_norm = 16, norm_type = 2)) # 31G
...
# CUDA_VISIBLE_DEVICES=5 python tools/train.py configs/ribfrac/retina_unet_r34_4l16c_rf1231_160x192x128_1cls_ohem_atssdy_vfl.py 
# CUDA_VISIBLE_DEVICES=1,3,5 PORT=29024 bash ./tools/dist_train.sh configs/ribfrac/retina_unet_r34_4l16c_rf1231_160x192x128_1cls_ohem_atssdy_vfl.py 3 --gpus 3 #--no-validate
