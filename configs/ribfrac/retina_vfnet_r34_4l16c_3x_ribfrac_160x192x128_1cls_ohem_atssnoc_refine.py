...
load_from = 'work_dirs/retina_vfnet_r34_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_refine/latest.pth'
resume_from = None # 'work_dirs/retina_vfnet_r34_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_refine/latest.pth' 
...
# CUDA_VISIBLE_DEVICES=5 python tools/train.py configs/ribfrac/retina_vfnet_r34_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_refine.py 
# CUDA_VISIBLE_DEVICES=1,3,5 PORT=29341 bash ./tools/dist_train.sh configs/ribfrac/retina_vfnet_r34_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_refine.py 3 --gpus 3 #--no-validate
