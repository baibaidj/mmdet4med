...
load_from = 'work_dirs/retina_unet_r34_4l16c_3x_ribfrac_160x192x128_3cls_ohem_atssnoc_vfl/latest.pth'
...
# CUDA_VISIBLE_DEVICES=0,2,4 PORT=29333 bash ./tools/dist_train.sh configs/ribfrac/retina_unet_r34_4l16c_3x_ribfrac_160x192x128_3cls_ohem_atssnoc_vfl_fapn.py 3 --gpus 3 #--no-validate
