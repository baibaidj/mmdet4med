_base_ = [
    '../_base_/models_med/retina_unet_repvgg_b0sd_atssnoc_160x192x128_syncbn.py',
...
model = dict(
        ...
        bbox_head = dict(anchor_generator = dict(verbose = False), 
                               loss_cls = dict(verbose = False), 
                                verbose = False), 
           )

find_unused_parameters=True
load_from = 'work_dirs/retina_unet_repvgg_b0sd_3x_ribfrac_160x192x128_1cls_ohem_atssnoc/latest.pth'
