...
model = dict(
        ...
        train_cfg= dict(
            initial_epoch=-3, alpha=1, beta=6, pos_weight=2.0,
            initial_assigner = dict(topk = 6, center_within = False, verbose = False), 
            assigner = dict(topk = 6, alpha = 1, beta = 6, verbose = False), 
...
load_from =  None # 'work_dirs/retina_unet_r34_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_tood_1130/latest.pth'
resume_from =  'work_dirs/retina_unet_r34_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_tood_1130/latest.pth' 
...
# CUDA_VISIBLE_DEVICES=5 python tools/train.py configs/ribfrac/retina_unet_r34_4l16c_3x_ribfrac_160x192x128_1cls_ohem_atssnoc_tood_1130.py 
