_base_ = [
    '../_base_/models_med/simmim_swint_4l16c_160x160x128.py',
...
data = dict(samples_per_gpu = 4, workers_per_gpu= 8, 
            train=dict(sample_rate = 0.2, json_filename = 'image_nii_fps_1025.txt', split='train'), 
...
load_from = None #'work_dirs/densecl_r18_4l16c_allct_bone_160x192x128_100eps/epoch_last_round1.pth'
resume_from = None  #'work_dirs/densecl_r18_4l16c_allct_bone_160x192x128_100eps/latest.pth'
...
# CUDA_VISIBLE_DEVICES=1 python tools/train.py configs/ribfrac/densecl_r18_4l16c_allct_bone_160x192x128_100eps.py --no-validate
# CUDA_VISIBLE_DEVICES=1,3 PORT=29010 bash ./tools/dist_train.sh configs/ribfrac/densecl_r18_4l16c_allct_bone_160x192x128_100eps.py 2 --gpus 2 --no-validate
