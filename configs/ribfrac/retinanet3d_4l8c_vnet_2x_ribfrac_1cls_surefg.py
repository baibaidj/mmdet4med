_base_ = [
    '../_base_/models/retinanet_r18_4l8c_vnet_3d_surefg.py',
...
# CUDA_VISIBLE_DEVICES=1 python tools/train.py configs/ribfrac/retinanet3d_4l8c_vnet_2x_ribfrac_1cls_surefg.py 
