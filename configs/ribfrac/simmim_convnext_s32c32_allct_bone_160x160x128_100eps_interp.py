_base_ = [
    '../_base_/models_med/simmim_convnext_s32c32_192x192x160.py', # s32= stride32
...
# CUDA_VISIBLE_DEVICES=5 python tools/train.py configs/ribfrac/simmim_convnext_s32c32_allct_bone_160x160x128_100eps_interp.py --no-validate

# CUDA_VISIBLE_DEVICES=1,3,5 PORT=29010 bash ./tools/dist_train.sh configs/ribfrac/simmim_convnext_s32c32_allct_bone_160x160x128_100eps_interp.py 3 --gpus 3 --no-validate
