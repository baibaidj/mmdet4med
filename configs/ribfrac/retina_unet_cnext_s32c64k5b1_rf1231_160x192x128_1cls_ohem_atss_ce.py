...
load_from = None #'work_dirs/retina_unet_cnext_s32c32k5b1_rf1231_160x192x128_1cls_ohem_atss_ce/latest.pth'
...
# CUDA_VISIBLE_DEVICES=0 python tools/train.py configs/ribfrac/retina_unet_cnext_s32c64k5b1_rf1231_160x192x128_1cls_ohem_atss_ce.py 
# CUDA_VISIBLE_DEVICES=0,2,4 PORT=29225 bash ./tools/dist_train.sh configs/ribfrac/retina_unet_cnext_s32c64k5b1_rf1231_160x192x128_1cls_ohem_atss_ce.py 3 --gpus 3 #--no-validate
