...
# CUDA_VISIBLE_DEVICES=1 python tools/train.py configs/ribfrac/densecl_r18_4l16c_ct5k_bone_160x192x128_100eps.py --no-validate
# CUDA_VISIBLE_DEVICES=1,3,5 PORT=29010 bash ./tools/dist_train.sh configs/ribfrac/densecl_r18_4l16c_ct5k_bone_160x192x128_100eps.py 3 --gpus 3 --no-validate
