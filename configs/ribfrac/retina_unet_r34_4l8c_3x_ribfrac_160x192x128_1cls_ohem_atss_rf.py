_base_ = [
    '../_base_/models/retina_unet_r34_4l8c_atss_160x192x128.py',
...
evaluation=dict(interval=20, iou_thr=[0.2], proposal_nums=(1, 2, 4, 8, 50))
# CUDA_VISIBLE_DEVICES=1 python tools/train.py configs/ribfrac/retina_unet_r34_4l8c_3x_ribfrac_160x192x128_1cls_ohem_atss_rf.py 
# CUDA_VISIBLE_DEVICES=0,2,4,5 PORT=29001 bash ./tools/dist_train.sh configs/ribfrac/retina_unet_r34_4l8c_3x_ribfrac_160x192x128_1cls_ohem_atss_rf.py 4 --gpus 4 #--no-validate
