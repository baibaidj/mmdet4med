...
model_name=retina_unet_r34_4l16c_3x_ribfrac_160x192x128_3cls_ohem_atssnoc_vfl_1222
weightfile=best_mAP_epoch_14.pth #'latest.pth' #
...
#     --model $model_name --not-ky-style --weight-file $weightfile \
#     --split $split --dataset-name $setname --gpu-ix 0 \
#     --fold-ix $foldix --num-fold 1 --verbose --fp16  --eval-final #--run_pids '1648270-20201005'  #
