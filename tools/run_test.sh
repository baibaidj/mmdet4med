...
# model=retinanet3d_4l8c_vnet_1x_ribfrac_syncbn_ft1cls
model=retinanet3d_4l8c_vnet_3x_ribfrac_1cls_syncbn #retinanet3d_4l8c_vnet_3x_ribfrac_1cls_syncbn
# model=retinanet3d_4l8c_vnet_1x_ribfrac_1cls


CUDA_VISIBLE_DEVICES=5 python tools/test_med.py configs/$task/$model.py \
